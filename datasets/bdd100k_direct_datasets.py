#adapted from https://github.com/chequanghuy/TwinLiteNet/blob/main/DataSet.py
import torch
import cv2
...
class BDD100KDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None, valid=False, size = (640, 320)):
        ...
        if valid:
            ...
            self.names= random.sample(os.listdir(self.root), 70000)
    ...
    def __getitem__(self, idx):
        ...
        drivable_path = os.path.join(self.root.replace("images", "labels/drivable/binary_colormask"), image_name.replace("jpg", "png"))
